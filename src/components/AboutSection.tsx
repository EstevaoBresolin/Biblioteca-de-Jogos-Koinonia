...
export function AboutSection() {
  const features = [{
    ...
    description: "Facilitamos o aluguel de jogos entre membros da comunidade aliança."
  }, {
    icon: <CalendarIcon className="h-8 w-8 text-mint" />,
    title: "Eventos Mensais",
    description: "Participe de nossos encontros mensais, torneios e noites de jogos temáticas."
  }];
  return <section className="py-20 bg-navy relative">
